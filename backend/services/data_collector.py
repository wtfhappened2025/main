...
SEED_EXPLANATIONS = {
    "Why Nvidia stock exploded today": {
        ...
        "card_3": "Tech markets reacted with a massive rally, pushing Nvidia to new highs.",
        ...
        "card_3_detail": "Nvidia is now one of the most valuable companies on Earth. Its chips power the entire AI revolution.",
        "category": "finance",
    },
    "TikTok ban is actually happening": {
        ...
        "card_3": "150 million American users could lose access to the platform.",
        ...
        "card_3_detail": "Creators and small businesses that depend on TikTok face an uncertain future. Competitors like Instagram Reels are positioning to absorb users.",
        "category": "technology",
    },
    "OpenAI launched autonomous agents": {
        ...
        "card_3": "This could transform how people work, automating complex tasks previously requiring human judgment.",
        ...
        "card_3_detail": "Industries from customer service to software development could see massive productivity shifts.",
        "category": "ai",
    },
    "The Fed just cut rates again": {
        ...
        "card_3": "Cheaper borrowing could boost housing, stocks, and consumer spending.",
        ...
        "card_3_detail": "Mortgage rates may finally drop, giving relief to homebuyers. Stock markets typically rally on rate cuts.",
        "category": "economy",
    },
    "EU just fined Apple 2 billion euros": {
        ...
        "card_3": "This sets a precedent for how tech giants can control their platforms.",
        ...
        "card_3_detail": "The ruling could force Apple to open up its ecosystem, potentially lowering prices for consumers.",
        "category": "technology",
    },
    "Bitcoin hits new all-time high": {
        ...
        "card_3": "Crypto is becoming mainstream finance, not just a speculative asset.",
        ...
        "card_3_detail": "Pension funds and institutional portfolios are now allocating to Bitcoin, legitimizing it as an asset class.",
        "category": "crypto",
    },
    "NASA discovers high potential for life on Europa": {
        ...
        "card_3": "This is the closest we've come to finding evidence that we might not be alone.",
        ...
        "card_3_detail": "If life exists on Europa, it would fundamentally change our understanding of biology and our place in the universe.",
        "category": "science",
    },
    "Why is the internet obsessed with the Hawk Tuah girl": {
        ...
        "card_3": "She turned viral fame into a media career, showing how internet culture creates new celebrities.",
        ...
        "card_3_detail": "She launched a podcast, merchandise line, and secured brand deals — the modern blueprint for viral fame monetization.",
        "category": "internet_culture",
    },
}
